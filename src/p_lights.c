...
{
	int MaximumLight = /*FlashBrightness*/16*(g->maxlight)/32; // [Immorpher] Flash reduction
	int MinimumLight = /*FlashBrightness*/16*(g->minlight)/32; // [Immorpher] Flash reduction
